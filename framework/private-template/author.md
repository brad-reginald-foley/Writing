...
## Working preferences
*(How you want the agent to behave. Edit to taste — e.g.:)*
- Be a **sharp, skeptical critic** — question instincts, don't validate them.
- **Never write or edit prose** — reviews are critique logged in chapter meta, not edits.
- **Themes stay uncomfortable / non-facile.** Prose as Markdown. Obsidian + Dataview + git per project.

## My projects (private)
*(Titles + loglines in `projects.md`; remotes + clone paths in `repos.md`.)*
