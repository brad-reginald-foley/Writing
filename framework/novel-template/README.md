...
> Setup: open as an **Obsidian vault**, enable **Dataview**. Links are filename-based
> `[[wikilinks]]`. Prose (when drafting) lives in `drafts/ch-NNN/ch-NNN.md` and is **100% the
> author's — the assistant never edits prose.** Versioned with **git**.
